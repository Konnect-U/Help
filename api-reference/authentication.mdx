...
The Konnect-U API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your Konnect-U account at [https://app.konnect-u.com/](https://app.konnect-u.com/)
...
```bash
curl -X GET "https://app.konnect-u.com//api/user/campaigns" \
