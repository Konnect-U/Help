...
```bash cURL
curl -X GET "https://app.konnect-u.com//api/user/conversations?type=widget&per_page=10" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript JavaScript
const response = await fetch(
  'https://app.konnect-u.com//api/user/conversations?type=widget&per_page=10',
  {
    headers: {
...
response = requests.get(
    'https://app.konnect-u.com//api/user/conversations',
...
```json 200 Response
{
  ...
  "first_page_url": "https://app.konnect-u.com//api/user/conversations?page=1",
  "from": 1,
  "last_page": 5,
  "last_page_url": "https://app.konnect-u.com//api/user/conversations?page=5",
  "links": [
    {
      "url": null,
    ...
    {
      "url": "https://app.konnect-u.com//api/user/conversations?page=1",
      "label": "1",
      "active": true
    },
    {
      "url": "https://app.konnect-u.com//api/user/conversations?page=2",
      "label": "2",
      "active": false
    }
  ],
  "next_page_url": "https://app.konnect-u.com//api/user/conversations?page=2",
  "path": "https://app.konnect-u.com//api/user/conversations",
  "per_page": 15,
  "prev_page_url": null,
  "to": 15,
  "total": 68
