...
```bash cURL
curl -X POST "https://app.konnect-u.com//api/conversations/7c9e6679-7425-40de-944b-e07fc1f90ae7/messages" \
...
const response = await fetch(
  `https://app.konnect-u.com//api/conversations/${conversationId}/messages`,
  {
    method: 'POST',
    headers: {
...
response = requests.post(
    f'https://app.konnect-u.com//api/conversations/{conversation_id}/messages',
    json={
        'message': 'I would like to schedule a demo for next week'
    }
)
