...
```bash cURL
curl -X GET "https://app.konnect-u.com//api/user/whatsapp/senders" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```bash Filter all senders
curl -X GET "https://app.konnect-u.com//api/user/whatsapp/senders?status=all" \
  -H "Authorization: Bearer YOUR_API_KEY"
```

```javascript JavaScript
const response = await fetch(
  'https://app.konnect-u.com//api/user/whatsapp/senders',
  {
    headers: {
