...
```bash cURL
curl -X POST "https://app.konnect-u.com//api/user/ai/generate-reply" \
...
const response = await fetch('https://app.konnect-u.com//api/user/ai/generate-reply', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://app.konnect-u.com//api/user/ai/generate-reply',
    headers={
        'Authorization': 'Bearer YOUR_API_TOKEN',
        'Content-Type': 'application/json'
    },
...
$response = Http::withToken('YOUR_API_TOKEN')
    ->post('https://app.konnect-u.com//api/user/ai/generate-reply', [
        'assistant_id' => 123,
        'customer_identifier' => '+14155551234',
        'message' => 'Hi, I would like to schedule an appointment',
        'variables' => [
...
Build your own chat interface powered by your Konnect-U assistant:
