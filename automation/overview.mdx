...
description: "Learn about Konnect-U's built-in automation engine for creating workflows without coding"
---
...
Konnect-U includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Konnect-U (e.g., "call ended," "inbound call context injection").
