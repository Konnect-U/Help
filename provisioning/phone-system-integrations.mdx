...
icon: "phone-office"
description: "Learn how to integrate Konnect-U with your existing PBX or VOIP infrastructure through SIP trunks"
---

For businesses with existing PBX or VOIP infrastructure, Konnect-U can integrate through SIP trunks or direct connections:

## 1. SIP Trunk

- **How It Works**: You share your SIP credentials (server, username, password). Konnect-U configures a trunk internally.
...
- If your PBX already handles call routing, pass the call to Konnect-U only when certain conditions are met (like after IVR selection).
...
- Carrier charges from your PBX provider still apply, plus any Konnect-U usage fees.
