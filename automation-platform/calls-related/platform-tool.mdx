---
title: "Konnect-U Tool"
icon: "phone"
description: "Learn how to use Konnect-U triggers and actions in your AI calling flows"
---

# Konnect-U Tool

The Konnect-U tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the Konnect-U tool prominently displayed at the top of the
...
![Konnect-U Call Ended Trigger](/resources/autocalls-trigger.jpg)
...
![Konnect-U Action](/resources/autocalls-action.jpg)
