...
icon: "credit-card"
description: "Learn how Konnect-U billing works, including call minutes calculation, phone number rentals, and usage monitoring"
---

Konnect-U operates on a **usage-based** model. You pay primarily for two things:
...
- **Per-Second Billing**: Beyond 30 seconds, Konnect-U bills by the second (converted to minutes). For example, a 90-second call is 1.5 minutes.
