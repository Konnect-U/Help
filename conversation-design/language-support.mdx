...
Konnect-U offers multiple languages and accents for your AI assistant. Choose from built-in sets or request new ones if needed.
...
- **Others**: +40 languages supported, [play samples here](https://www.konnect-u.com//#languages-available)

## 2. Requesting a New Language

- If your language is missing, [contact support](https://www.konnect-u.com/contact-us). We may add it if feasible. Some might require a one-time fee for model training or verification.
